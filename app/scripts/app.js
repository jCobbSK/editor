...
class App {
  ...
  saveContent() {
    localStorage.content = this.editor.getValue();
  ...
  onClickFinish() {
    const confirm = prompt('This will show the results of your code. Doing this before the round is over WILL DISQUALIFY YOU. Are you sure you want to proceed? Type "yes" to confirm.');
